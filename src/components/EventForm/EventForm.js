...
return (
  <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="modal bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
